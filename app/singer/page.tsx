...
const singerSong = [{ name: "爱是昂贵的", singer: "声音玩具", album: "劳动之余", time: '08:06' }, { name: "秋分", singer: "蛙池", album: "郊游", time: '04:05' }, { name: "爱是昂贵的", singer: "声音玩具", album: "劳动之余", time: '3:05' }]
        ...
        <div className="flex ml-[220px]">
            ...
            <div className="flex flex-col ml-[15px]">
                ...
                <div className="mt-[10px] text-sm">
                    ...
                    <div className="mt-[17px]">国籍：中国 出生地：辽宁沈阳 生日:2000年6月1月 职业：音乐人，潮牌主理人 </div>
                    <div className="mt-[17px]">单曲：120 ｜ 专辑：15</div>
                    <div><Button className="bg-orange-400 mt-[17px]">
                        + 播放热门歌曲
                    </Button>
                    </div>
                </div>
